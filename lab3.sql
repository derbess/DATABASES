...
SELECT name, lastname FROM employees
  WHERE department=(SELECT code FROM departments ORDER BY budget asc  offset 0 limit 1);

SELECT name,lastname FROM employees where city = 'Almaty'
UNION SELECT name,lastname FROM customers WHERE city = 'Almaty';

SELECT *FROM departments WHERE budget > 6000 ORDER BY budget asc, code desc;
